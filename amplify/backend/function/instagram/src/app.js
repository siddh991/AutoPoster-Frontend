...
app.post("/instagramaccesstoken", async (req, res) => {
  try {
    const { code } = req.body;
    const decode = decodeURI(code);
    const tokenEndpoint = "https://api.instagram.com/oauth/access_token/";
    const params = {
      client_id: "785546827123900",
      client_secret: "2a9b2d0ffcc49c7b85b346e22a9ec3a9",
      grant_type: "authorization_code",
      redirect_uri:"https://www.influent.studio/instagram-redirect",
      code: decode,
    };
